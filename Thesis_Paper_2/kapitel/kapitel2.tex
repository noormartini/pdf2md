...
and mathematical notation. Prompt instructions can guide this further: specifying the desired output
format, the document language, and the content type of the page in the system
prompt pushes the model toward structured, consistent output. This combination
of visual input and prompt-driven control is what the image-based and hybrid
extraction strategies in this thesis rely on.
...
time. These systems can extract text, images, and tables in a single pass and
