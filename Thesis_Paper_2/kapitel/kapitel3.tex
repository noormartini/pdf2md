...
Meuschke et al.\ \autocite{meuschke2023} evaluated these tools across academic,
...
documents that required positional grouping. Ingemarsson and Persson \autocite{ingemarsson2024} identified
...
to read. For mathematical expressions, Gao et al.\ \autocite{gao2011} show that
...
Blecher et al.\ \autocite{blecher2023} introduced Nougat (Neural Optical
...
separate layout step. Meuschke et al.\ \autocite{meuschke2023} confirmed this
...
109 languages and outputs structured Markdown or JSON. Duan \autocite{duan2025}
