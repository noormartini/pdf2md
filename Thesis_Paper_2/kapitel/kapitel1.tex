...
process. OCR tools such as Tesseract \autocite{smith2007} treat the page as a flat
...
empty, and routes it to the extraction method best suited to that type. The system runs locally using LM Studio as the LLM
...
The choice matters for downstream tasks. Khan et al.\ \autocite{khan2024} show
...
Ingemarsson and Persson \autocite{ingemarsson2024} reached a similar conclusion
...
For text pages, heading levels are inferred from font sizes. The system
tallies font sizes by character count to find the dominant body text size, then
promotes spans that are 15\%, 40\%, and 80\% larger to heading levels H3, H2,
and H1 respectively. For pages routed to the vision path,
