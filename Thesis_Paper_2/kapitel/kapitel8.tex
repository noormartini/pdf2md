...
predicted. Hypothesis H1 expected the adaptive system to outperform every fixed
strategy, and hypothesis H4 expected hybrid to be a strong baseline. Neither held
for this corpus. The explanation lies in the document type. Thesis documents
consist largely of continuous prose, and PyMuPDF extracts machine-typed text with
near-perfect character accuracy. A vision-language model given a rendered page
image paraphrases the content rather than transcribing it, which introduces errors
that accumulate across paragraphs and code blocks regardless of the model's visual
capability.
...
paragraph structure score of 0.156 and code block score of 0.250 reveal structural
failures that a single aggregate score would hide. Flat sequence metrics reward
