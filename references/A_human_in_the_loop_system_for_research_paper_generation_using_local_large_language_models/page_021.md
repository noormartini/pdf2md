...
|---|---|---|---|
| FR1 | Functional | Context Analysis | The system shall process user data to generate a structured research topic definition. |
...
| FR3 | Functional | Hypothesis Generation | The system shall derive a formal hypothesis from the provided context. |
...
| FR8 | Functional | Model Selection | The system shall allow the assignment of LLMs to specific tasks (for example coding versus writing). |
