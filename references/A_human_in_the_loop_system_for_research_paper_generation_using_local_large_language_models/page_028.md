**User Inputs** The process begins at the application's start screen, shown in Figure 4.3. Here, the user can open the settings, edit the paper specification and the style guidelines file, and optionally upload code and datasets.
