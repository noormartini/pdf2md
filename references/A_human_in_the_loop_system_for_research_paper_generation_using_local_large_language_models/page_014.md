...
HITL is a term for interaction paradigms where humans are part of the learning or decision-making process of a machine learning (ML) system [27]. It aims to improve both accuracy and efficiency of ML systems while also making humans more effective [27]. How this paradigm is applied here is discussed in Chapter 4.
