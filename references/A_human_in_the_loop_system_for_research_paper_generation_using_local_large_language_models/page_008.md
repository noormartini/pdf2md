...
| 4.2 | HITL interaction flow | 16 |
| 4.3 | Application start screen | 18 |
| 4.4 | Context analysis flow | 21 |
| 4.5 | Research context screen | 22 |
| 4.6 | Literature search flow | 24 |
| 4.7 | Literature search screen | 27 |
| 4.8 | Hypothesis generation flow | 29 |
| 4.9 | Hypothesis generation screen | 29 |
| 4.10 | Experimentation flow | 31 |
| 4.11 | Experiment plan screen | 32 |
| 4.12 | Experiment results screen | 33 |
| 4.13 | Paper writing flow | 35 |
| 4.14 | Paper draft screen | 37 |
| 4.15 | Document compilation flow | 38 |
| 4.16 | Result screen | 39 |
| 6.1 | Generated first-digit frequency comparison | 55 |
