...
across six document categories and found that even the top performers, PyMuPDF and pypdfium, failed on scientific and
patent documents.
...
Each chapter addresses a different aspect of the work.
...
acknowledged limitations, and directions for future work, including multilingual evaluation, additional
input formats, and integration with newer multimodal LLM architectures.
