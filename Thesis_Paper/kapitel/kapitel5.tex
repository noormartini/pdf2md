...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.48\textwidth]{postprocessing.png}
...
Italic spans containing only Greek letters are converted to inline LaTeX (e.g.\ \texttt{\_φ\_} $\to$ \texttt{\$\textbackslash varphi\$}).
