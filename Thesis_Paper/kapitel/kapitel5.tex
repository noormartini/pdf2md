...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth,height=0.88\textheight,keepaspectratio]{architecture.png}
...
Two safeguards keep this routing from losing content. Both appear in Figure~\ref{fig:classifier}.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.90\textwidth,height=0.88\textheight,keepaspectratio]{classifier.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.50\textwidth,height=0.84\textheight,keepaspectratio]{postprocessing.png}
